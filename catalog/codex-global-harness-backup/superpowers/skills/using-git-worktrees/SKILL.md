...
Default shell guidance is Windows-first. If the current environment is not Windows, load the matching OS environment skill before interpreting shell snippets, global paths, or examples in this skill.
