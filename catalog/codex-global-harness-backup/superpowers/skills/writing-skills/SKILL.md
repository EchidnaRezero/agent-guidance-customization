...
When environment behavior differs by operating system, prefer separate OS-specific skills instead of mixing Windows, macOS, Linux, and WSL guidance into one skill body.
