...
description: "Use when writing or checking docs about codebase structure, relationships, behavior, or mappings."
---
...
- Apply `when-writing-or-checking-markdown-docs` first.
