...
If you need to restore support for another agent later, see [docs/non-codex-recovery-guide_kr.md](docs/non-codex-recovery-guide_kr.md).
...
**By default, project work follows this workflow unless a more specific local workflow replaces it.**
