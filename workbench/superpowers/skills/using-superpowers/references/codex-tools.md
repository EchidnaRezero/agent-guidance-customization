...
Some upstream skills still use legacy tool names. When you encounter them in a skill, use your Codex equivalent:
...
Some upstream skills reference named agent types like `superpowers:code-reviewer`.
